...
public interface OfferDao {
    ...
    @SqlQuery("""
        SELECT id, name, offer_type as offerType, is_active as isActive,
               ...
               combo_price as comboPrice, priority,
    ...
    @SqlUpdate("""
        INSERT INTO offers (name, offer_type, is_active, start_date, end_date, combo_price, priority, created_by)
        VALUES (:name, :offerType, :isActive, :startDate, :endDate, :comboPrice, :priority, :createdBy)
        """)
    @GetGeneratedKeys("id")
    ...
    @SqlQuery("""
        SELECT oi.id, oi.offer_id as offerId, oi.product_id as productId, oi.variant_id as variantId,
               ...
               p.name as productName, v.sku as variantSku
        FROM offer_items oi
